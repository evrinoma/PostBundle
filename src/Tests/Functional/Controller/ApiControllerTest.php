...
namespace Evrinoma\PostBundle\Tests\Functional\Controller;

use Evrinoma\PostBundle\Fixtures\FixtureInterface;
...
{
    protected string $actionServiceName = 'evrinoma.post.test.functional.action.post';
    ...
    {
        return [FixtureInterface::POST_FIXTURES];
    }
}
